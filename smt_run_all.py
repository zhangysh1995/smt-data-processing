...
parser.add_argument('--cconfig', type=str, help='point to your configuration files (e.g config.)')
...
if args.case is None:
	if pwd.getpwuid(os.geteuid()).pw_name == 'zhangysh1995':
		split_project('/home/zhangysh1995/ctags', cpus)
	elif pwd.getpwuid(os.geteuid()).pw_name == 'root':
		split_project('/root/PPBV', cpus)
else:
		split_project(args.case, cpus)
